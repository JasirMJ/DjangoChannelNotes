...
SECRET_KEY = 'f%n-qa0y5hbfxyz*0p&f_#+eioi)-3m)b3cjgdyn=@p!o=n4a+'
...
CORS_ORIGIN_WHITELIST = (
    'http://localhost:3000', # React, (everytinh from localhost:3000 is alowed to access this api)
)
